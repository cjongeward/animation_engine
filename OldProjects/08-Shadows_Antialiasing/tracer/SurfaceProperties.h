...
struct SurfaceProperties {
  ...
  float intensity;
  constexpr SurfaceProperties(const Color& t_color, float t_diffuse, float t_spec, int t_spec_exp, float t_reflect, float t_intensity) :
    color{ t_color },
...
constexpr SurfaceProperties LIGHT{ WHITE, 1.0f, 1.0f, 100, 0.0f, 1.f };
