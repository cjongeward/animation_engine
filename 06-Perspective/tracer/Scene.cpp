...
std::vector<std::unique_ptr<Shape>> Scene::getFrame()
{
  ...
  Rect rect{ vec{1.f, 1.8f, -6.f}, vec{1.0f, 1.f, -6.5f}, vec{0.5f, 2.f, -6.5f}, BRIGHT };
  ...
  Rect floor{ vec{-10.f, -4.f, -20.f}, vec{-10.f, -4.f, 0.f}, vec{10.f, -4.f, -20.f}, GRAYISH };
  Rect wall1{ vec{-10.f, -4.f, -20.f}, vec{-10.f, 4.f, -20.f}, vec{-10.f, -4.f, 0.f}, YELLOWISH };
  Rect wall2{ vec{10.f, -4.f, 0.f}, vec{10.f, 4.f, 0.f}, vec{10.f, -4.f, -20.f}, YELLOWISH };
  ...
  Rect mirror{ vec{3.f, -2.f, -19.9f}, vec{3.f, 2.f, -19.9f}, vec{-3.f, -2.f, -19.9f}, MIRRORISH };
