...
std::vector<std::unique_ptr<Shape>> Scene::getFrame()
{
  ...
  Mesh bunny{ "../bunny_simple2.off", WHITEISH};
  bunny.transform(mat::translation(vec{-5.f, 0.f, -10.f}) * mat::scale(vec{2.f, 2.f, 2.f}));
  ...
  shapes.push_back(std::make_unique<Box>(std::move(box1)));
  shapes.push_back(std::make_unique<Box>(std::move(box2)));
  shapes.push_back(std::make_unique<Box>(std::move(box3)));
  shapes.push_back(std::make_unique<Box>(std::move(plank2)));
  shapes.push_back(std::make_unique<Box>(std::move(win1)));
  shapes.push_back(std::make_unique<Box>(std::move(win2)));
  shapes.push_back(std::make_unique<Box>(std::move(plank)));
  ...
  shapes.push_back(std::make_unique<Mesh>(std::move(bunny)));
  return shapes;
}
