...
std::vector<DrawableShape> Scene::getFrame()
{
  ...
  DrawableShape sphere3{ std::make_unique<Sphere>(vec{1.5f, -3.f, -13.f}, 1.f ), BRIGHT};
  DrawableShape sphere4{ std::make_unique<Sphere>(vec{3.5f, -3.f, -8.f}, 1.f), DULL };
  ...
  box1.shape->transform(mat::translation(vec{-7.f, -3.f, -17.f}) * mat::scale(vec{2.f, 2.f, 2.f}));
  ...
  box2.shape->transform(mat::translation(vec{0.f, -3.f, -6.f}) * mat::rotation(PI4, 0.f, 0.f) * mat::scale(vec{1.f, 2.f, 1.f}));
  DrawableShape box3{std::make_unique<Box>(), WHITEISH};
  box3.shape->transform(mat::translation(vec{3.f, -3.f, -9.f}) * mat::rotation(PI4, 0.f, 0.f) * mat::scale(vec{1.f, 2.f, 1.f}));
  DrawableShape plank2{std::make_unique<Box>(), BROWNISH};
  plank2.shape->transform(mat::translation(vec{1.5f, -1.93, -7.5f}) * mat::rotation(-PI4, 0.f, 0.f) * mat::scale(vec{1.0f, 0.15f, 6.f}) );
  ...
  DrawableShape bunny{std::make_unique<Mesh>( "../bunny_simple2.off"), WHITEISH};
  bunny.shape->transform(mat::translation(vec{-5.f, 0.f, -10.f}) * mat::scale(vec{2.f, 2.f, 2.f}));
